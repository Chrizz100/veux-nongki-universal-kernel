...
# VEUX 5.4.292 ReSukiSU + SUSFS 2.3.0 compile V4
...
INTEGRATOR="$PROJECT_ROOT/lineages/5.4.292/SUSFS_INTEGRATE_V4.py"
INTEGRATOR_EXPECTED_SHA256="82cb2ec0d4c068ffb048aa93bbb8216dd65d441ecdac1cb7c8d823f17474fffa"

WORK_ROOT="${1:-$PROJECT_ROOT/.work/5.4.292-susfs-v4}"
...
echo "SUSFS V4 compile finished successfully."
