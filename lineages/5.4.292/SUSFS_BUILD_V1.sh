...
# VEUX 5.4.292 ReSukiSU + SUSFS 2.3.0 compile V1
...
INTEGRATOR="$PROJECT_ROOT/lineages/5.4.292/SUSFS_INTEGRATE_V1.py"
INTEGRATOR_EXPECTED_SHA256="6322d822c1e55fc09498d8fe22f4e380b387156fecf8b2df9b76363b773e243b"

WORK_ROOT="${1:-$PROJECT_ROOT/.work/5.4.292-susfs-v1}"
...
python3 "$INTEGRATOR" "$SRC" "$RS" "$DONOR" "$SUSFS" | tee "$RESULTS/integration.log"
for gate in \
...
echo "SUSFS V1 compile finished successfully."
