...
# VEUX 5.4.292 ReSukiSU + SUSFS 2.3.0 compile V2
...
INTEGRATOR="$PROJECT_ROOT/lineages/5.4.292/SUSFS_INTEGRATE_V2.py"
INTEGRATOR_EXPECTED_SHA256="e3629f5a48c465e7984dc0abb06875e8dd528265e309089ace09fe4a2ad4c278"

WORK_ROOT="${1:-$PROJECT_ROOT/.work/5.4.292-susfs-v2}"
...
echo "SUSFS V2 compile finished successfully."
