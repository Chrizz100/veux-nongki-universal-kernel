...
# VEUX 5.4.292 ReSukiSU + SUSFS 2.3.0 compile V5
...

{
  ...
  echo "UPSTREAM_CLONE_MNT_RACE_FIX_BACKPORT=PASS"
  ...
  echo "RUN35350262681_REGRESSION=PASS"
  echo "RUN35352162500_REGRESSION=PASS"
...
echo "SUSFS V5 compile finished successfully."
