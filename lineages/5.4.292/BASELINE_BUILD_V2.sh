...
# VEUX 5.4.292 native baseline build V2
...
WORK_ROOT="${1:-$PROJECT_ROOT/.work/5.4.292-baseline-v2}"
...
echo "=== VEUX 5.4.292 NATIVE BASELINE V2 ==="
...
echo
echo "Baseline V2 compile finished successfully."
