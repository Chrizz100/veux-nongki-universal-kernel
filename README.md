...
* **5.4.292, 5.4.293, 5.4.300, 5.4.301 and 5.4.302** are newer VEUX-compatible Linux 5.4 lineages / stable ports.
...
|**5.4.301**|35157 / `3d1185d8`|4|2.3.0|A13 stock vendor|**STATIC BOOT PASS**|
...
### 5.4.292 / 5.4.293 / 5.4.300 / 5.4.301 / 5.4.302
...
* 5.4.292 / 5.4.293 / 5.4.300 / 5.4.301 / 5.4.302 should be treated as test builds until real-device validation is completed
* Do not describe 5.4.292 / 5.4.293 / 5.4.300 / 5.4.301 / 5.4.302 as official Xiaomi stock-kernel releases
